...
app.use('/generatePDF', require('./routes/PDF_generate'))
...
app.use('/api', require('./routes/orderRouterKM'))
...
if(process.env.NODE_ENV === 'production'){
    app.use(express.static('SPM_explores_CAFE_frontend/build'))
    app.get('*', (req, res) =>{
        res.sendFile(path.join(__dirname, 'SPM_explores_CAFE_frontend', 'build', 'index.html'))
    })
}
